...
def main():
    ...
    if args.is_training == 0:
        from log.melspec_class_equalprob_average_fold1.code.model_use1 import ResNet_MIT
        from log.melspec_class_equalprob_average_fold1.code.load_data import MyDataset
        ...
        for checkpoint_number in checklis:
            ...
            for item in test_lis:
                test_file1='./dataset/fold6/'+item+'.scp'
